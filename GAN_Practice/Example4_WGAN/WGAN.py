...
class WGAN:
    ...
    def build_model(self):
        ...
        self.d_fake_loss = tf.reduce_mean(self.fake_unit)
        self.d_real_loss = -tf.reduce_mean(self.real_unit)
        # generator loss
        self.g_loss = -tf.reduce_mean(self.fake_unit)
        # discriminator loss
    ...
    def train_model(self):
        ...
        for epoch in range(self.config.epoch):
            ...
            for ite in tqdm(range(50000/self.batchsize)):
                ...
                _, _, d_loss, summaries = self.sess.run([self.d_optim, self.clip_updates, self.d_loss, self.summaries], feed_dict={self.z:noise_z,
