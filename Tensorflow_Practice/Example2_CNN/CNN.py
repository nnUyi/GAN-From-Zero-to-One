...
class CNN:
    ...
    def cnn(self, input_x, scope_name='cnn', is_training=False, reuse=False):
        # Architecture: (64)5c2s_BR-(128)5c2s_BR-(256)5c2s_BR-(dropout)-FC1024-BR-FC512-BR-FC10_SoftMax
        # correct rate: 99.45%
        ...
        with tf.variable_scope(scope_name) as scope:
            ...
            with slim.arg_scope([slim.conv2d, slim.fully_connected],
                ...
                # 512
                fc1 = slim.fully_connected(fc0, 512, scope='fc1')
                # fc2_drop = slim.dropout(fc2, 0.5, scope='fc2_drop')
                # 10
                logits = slim.fully_connected(fc1, 10, activation_fn=None, normalizer_fn=None, scope='d_output')
    ...
    def build_model(self):
        ...
        self.input_x = tf.placeholder(dtype=tf.float32,
                                      ...
                                      name='input_x')
        # CNN forward training phase
        self.pred_logits, self.pred_softmax = self.cnn(self.input_x, is_training=True, reuse=False)
        # CNN forward testing phase
        self.test_logits, self.test_softmax = self.cnn(self.input_x, is_training=False, reuse=True)
